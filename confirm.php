...
<body class="bg-dark">
    ...
    <main>
        ...
        <section class="container-fluid confirm-s1 d-flex py-3 align-items-center minh-50vh bg-white">
            <div class="my-auto w-100">
                <div class="row w-100 py-5">
                    <div class="col-xs-12 col-sm-8 col-md-6 offset-sm-2 offset-md-3 text-center">
                        <div class="card p-3 shadow">
                            <h3 class="text-center font-header text-dark mb-3">Message sent!</h3>
                            <table class="table table-sm table-hover border text-left font-menu bg-light opacity-8">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                            if(isset($_POST['ftablesize']))
                                                echo htmlspecialchars($_POST['ftablesize']);
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if(isset($_POST['fdate']))
                                                echo htmlspecialchars($_POST['fdate']);
                                            ?>
                                        </td>
                                    </tr>
                                </tbody>
